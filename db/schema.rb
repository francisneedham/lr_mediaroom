...
ActiveRecord::Schema.define(:version => 20120331073950) do
  ...
  add_index "galleries", ["published"], :name => "index_galleries_on_published"
  ...
  add_index "videos", ["published"], :name => "index_videos_on_published"
